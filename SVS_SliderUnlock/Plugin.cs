...
[BepInPlugin("SVS_SliderUnlock", "SVS Slider Unlock", "2.0.0")]
public class Plugin : BasePlugin
{
	private static class NativeMethods
	{
		...
		public static extern bool VirtualProtect(System.IntPtr lpAddress, System.UIntPtr dwSize, uint flNewProtect, out uint lpflOldProtect);

		[DllImport("kernel32.dll")]
		public static extern System.IntPtr VirtualAlloc(System.IntPtr lpAddress, System.UIntPtr dwSize, AllocationType lAllocationType, MemoryProtection flProtect);
	}
	...
	{
		Log = base.Log;
		Minimum = base.Config.Bind("Slider Limits", "Minimum slider value", -100, new ConfigDescription("Changes will take effect next time the editor is loaded or a character is loaded.", new AcceptableValueRange<int>(-500, 0)));
		Maximum = base.Config.Bind("Slider Limits", "Maximum slider value", 200, new ConfigDescription("Changes will take effect next time the editor is loaded or a character is loaded.", new AcceptableValueRange<int>(100, 500)));
		...
		try
		{
			processModule = ((IEnumerable)Process.GetCurrentProcess().Modules).Cast<ProcessModule>().First((ProcessModule x) => x.ModuleName == "GameAssembly.dll");
		}
		catch (System.Exception t)
		{
			ManualLogSource log2 = Log;
			BepInExErrorLogInterpolatedStringHandler bepInExErrorLogInterpolatedStringHandler = new BepInExErrorLogInterpolatedStringHandler(34, 1, out isEnabled);
			if (isEnabled)
			{
				bepInExErrorLogInterpolatedStringHandler.AppendLiteral("Failed to find GameAssembly.dll - ");
		...
		using UnmanagedMemoryStream unmanagedMemoryStream = new UnmanagedMemoryStream((byte*)(void*)intPtr, num, num, FileAccess.ReadWrite);
		...
		if (!NativeMethods.VirtualProtect(lpAddress, (System.UIntPtr)(ulong)array.Length, NativeMethods.PAGE_EXECUTE_READWRITE, out var lpflOldProtect))
		{
			ManualLogSource log3 = Log;
			BepInExErrorLogInterpolatedStringHandler bepInExErrorLogInterpolatedStringHandler = new BepInExErrorLogInterpolatedStringHandler(129, 1, out isEnabled);
			if (isEnabled)
			{
				bepInExErrorLogInterpolatedStringHandler.AppendLiteral("[CharacterCreation.HumanCustom.__c__DisplayClass194_0._EntryUndo_b__4] Failed to change memory protection, aborting. Error code: ");
				bepInExErrorLogInterpolatedStringHandler.AppendFormatted(Marshal.GetLastWin32Error());
			}
		...
		else
		{
			...
			NativeMethods.VirtualProtect(lpAddress, (System.UIntPtr)(ulong)array.Length, lpflOldProtect, out lpflOldProtect2);
			ManualLogSource log4 = Log;
			bepInExInfoLogInterpolatedStringHandler = new BepInExInfoLogInterpolatedStringHandler(79, 0, out isEnabled);
			if (isEnabled)
			{
				bepInExInfoLogInterpolatedStringHandler.AppendLiteral("[CharacterCreation.HumanCustom.__c__DisplayClass194_0._EntryUndo_b__4] Success!");
			}
		...
		if (!NativeMethods.VirtualProtect(lpAddress2, (System.UIntPtr)(ulong)array2.Length, NativeMethods.PAGE_EXECUTE_READWRITE, out var lpflOldProtect3))
		{
			...
			if (isEnabled)
			{
				bepInExErrorLogInterpolatedStringHandler.AppendLiteral("[IsFace] Failed to change memory protection, aborting. Error code: ");
				bepInExErrorLogInterpolatedStringHandler.AppendFormatted(Marshal.GetLastWin32Error());
			}
		...
		else
		{
			...
			NativeMethods.VirtualProtect(lpAddress2, (System.UIntPtr)(ulong)array2.Length, lpflOldProtect3, out lpflOldProtect2);
			ManualLogSource log6 = Log;
			bepInExInfoLogInterpolatedStringHandler = new BepInExInfoLogInterpolatedStringHandler(17, 0, out isEnabled);
			if (isEnabled)
			{
		...
		if (!NativeMethods.VirtualProtect(lpAddress3, (System.UIntPtr)(ulong)array4.Length, NativeMethods.PAGE_EXECUTE_READWRITE, out var lpflOldProtect4))
		{
		...
		else
		{
			...
			NativeMethods.VirtualProtect(lpAddress3, (System.UIntPtr)(ulong)array4.Length, lpflOldProtect4, out lpflOldProtect2);
		...
		if (!NativeMethods.VirtualProtect(lpAddress4, (System.UIntPtr)(ulong)array6.Length, NativeMethods.PAGE_EXECUTE_READWRITE, out var lpflOldProtect5))
		{
			ManualLogSource log9 = Log;
			BepInExErrorLogInterpolatedStringHandler bepInExErrorLogInterpolatedStringHandler = new BepInExErrorLogInterpolatedStringHandler(74, 1, out isEnabled);
			if (isEnabled)
			{
				bepInExErrorLogInterpolatedStringHandler.AppendLiteral("[sub_180010BC0] Failed to change memory protection, aborting. Error code: ");
				bepInExErrorLogInterpolatedStringHandler.AppendFormatted(Marshal.GetLastWin32Error());
			}
		...
		else
		{
			...
			NativeMethods.VirtualProtect(lpAddress4, (System.UIntPtr)(ulong)array6.Length, lpflOldProtect5, out lpflOldProtect2);
			ManualLogSource log10 = Log;
			bepInExInfoLogInterpolatedStringHandler = new BepInExInfoLogInterpolatedStringHandler(24, 0, out isEnabled);
			if (isEnabled)
			{
		...
		System.IntPtr intPtr2 = (System.IntPtr)(delegate* unmanaged<System.IntPtr, System.IntPtr, float, System.IntPtr, System.IntPtr, System.IntPtr, System.IntPtr, byte>)(&GetInfo_hk);
		for (int i = 0; i < 8; i++)
		{
		...
		if (!NativeMethods.VirtualProtect(intPtr3, (System.UIntPtr)(ulong)array7.Length, NativeMethods.PAGE_EXECUTE_READWRITE, out var lpflOldProtect6))
		{
			ManualLogSource log11 = Log;
			BepInExErrorLogInterpolatedStringHandler bepInExErrorLogInterpolatedStringHandler = new BepInExErrorLogInterpolatedStringHandler(71, 1, out isEnabled);
			if (isEnabled)
			{
				bepInExErrorLogInterpolatedStringHandler.AppendLiteral("[GetInfo_hk] Failed to change memory protection, aborting. Error code: ");
				bepInExErrorLogInterpolatedStringHandler.AppendFormatted(Marshal.GetLastWin32Error());
			}
			log11.LogError(bepInExErrorLogInterpolatedStringHandler);
			return;
		}
		GetInfo_o = NativeMethods.VirtualAlloc(System.IntPtr.Zero, (System.UIntPtr)4096uL, NativeMethods.AllocationType.Commit | NativeMethods.AllocationType.Reserve, NativeMethods.MemoryProtection.ExecuteReadWrite);
		...
		using UnmanagedMemoryStream unmanagedMemoryStream2 = new UnmanagedMemoryStream((byte*)(void*)GetInfo_o, 4096L, 4096L, FileAccess.ReadWrite);
		...
		NativeMethods.VirtualProtect(intPtr3, (System.UIntPtr)(ulong)array7.Length, lpflOldProtect6, out lpflOldProtect2);
		ManualLogSource log12 = Log;
		bepInExInfoLogInterpolatedStringHandler = new BepInExInfoLogInterpolatedStringHandler(21, 0, out isEnabled);
		if (isEnabled)
		{
	...
	private unsafe static byte GetInfo_hk(System.IntPtr a1, System.IntPtr name, float rate, System.IntPtr a4, System.IntPtr a5, System.IntPtr a6, System.IntPtr flags)
	{
		float num = rate;
		if (rate > 1f)
		{
		...
		byte b = ((delegate* unmanaged<System.IntPtr, System.IntPtr, float, System.IntPtr, System.IntPtr, System.IntPtr, System.IntPtr, byte>)(void*)GetInfo_o)(a1, name, num, a4, a5, a6, flags);
		if (b != 0 && (rate < 0f || rate > 1f))
		{
			System.IntPtr intPtr = *(System.IntPtr*)(void*)(a1 + 16);
			System.IntPtr intPtr2 = default(System.IntPtr);
			if (((delegate* unmanaged<System.IntPtr, System.IntPtr, System.IntPtr, System.IntPtr, System.IntPtr*, byte>)(void*)dictionary_get_item_by_key)(System.IntPtr.Zero, System.IntPtr.Zero, intPtr, name, &intPtr2) != 0)
			{
				delegate* unmanaged<System.IntPtr, ulong, System.IntPtr, System.IntPtr> delegate_002A = (delegate* unmanaged<System.IntPtr, ulong, System.IntPtr, System.IntPtr>)list_get_item.ToPointer();
				...
				if (flag2)
				{
					...
					if ((!text.Contains("thigh") || !text.Contains("01")) && (!text.StartsWith("cf_a_bust") || !text.EndsWith("_size")))
					{
	...
	[HarmonyPostfix]
	[HarmonyPatch(typeof(HumanCustom), "ConvertRateFromText", new System.Type[]
	{
		typeof(int),
		typeof(int),
		typeof(string)
	...
	[HarmonyPrefix]
	[HarmonyPatch(typeof(HumanCustom), "EntryUndo", new System.Type[]
	{
