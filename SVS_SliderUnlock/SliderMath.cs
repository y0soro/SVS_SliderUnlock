...
internal class SliderMath
{
	...
	public static Vector3 SafeCalculateRotation(Vector3 original, string name, List<Data> list, float rate)
	{
		if (name.Contains("cf_s_Mune") || name.Contains("cf_s_Mouth") || name.Contains("cf_s_LegLow") || name.Contains("cf_s_MayuTip") || (name.Contains("thigh") && name.Contains("01")) || (name.StartsWith("cf_a_bust") && name.EndsWith("_size")))
		{
			return original;
		}
